...
namespace GameName3.Game
{
	...
	public class Game1 : Microsoft.Xna.Framework.Game 
	{
		...
		public GameLoad Load;

		public float gameDelta = 0.0f;
		...
		//Game Constants
		public const bool LIMIT_FRAMERATE = false;
		public const bool DRAW_MOUSE = false;
		...
		public Game1()
		{
			...
			this.IsMouseVisible = DRAW_MOUSE;
		...
		{
			//Load -> Input -> Update -> Render -> REPEAT
			base.Update(gameTime);
			gameDelta = gameTime.ElapsedGameTime.Milliseconds * 0.001f;
		}
...
namespace WindowsGame1 {
	public partial class Game1 : Microsoft.Xna.Framework.Game {
		...
		protected override void LoadContent() {
            ...
            ///
            /// Manually add in some date for testing - eventually all world data will be held in the relevant files.
            ///
			//Add hero data
