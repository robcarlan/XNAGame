...
namespace Scripts
{
	public partial class Script
	{
		...
		public static IEnumerable<float> someFunction(Character bob, Character target, ObjManager obj)
		{
			int i = 0;
			while (i < 1000)
			{
		...
		public static IEnumerable<float> dialogueScript(Game1 game)
		{
			...
			options.Add(parseString("I'm a happy chappy.", game.UI)[0]);
			...
			switch (getSelectedOption(game.UI))
			{
				...
				case 2:
					...
					break;
				default:
					game.UI.setDialogue("Okay, thats nice. ");
					yield return scriptWaitForInput(game.UI);
					break;
			}
