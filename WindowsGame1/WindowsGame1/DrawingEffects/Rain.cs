...
namespace WindowsGame1.DrawingEffects
{
    class Rain
    {
        ...
        public SpriteList rainSplash;

        Color rainColour = new Color();
        //Todo: add a rain sprite of it hitting the ground - randomly occurs on some rain

        public Rain( Texture2D _rainTex, Texture2D _rainSplash, SpriteList rainSplashSprite, Vector2 _Screen ) 
        {
