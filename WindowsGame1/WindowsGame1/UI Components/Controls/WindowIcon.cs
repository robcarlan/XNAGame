...
namespace WindowsGame1.UI_Components
{
    ...
    public class WindowIcon
    {
        ...
        public WindowIcon(Vector2 windowBaseBegin, Vector2 IconArea, int height, int width, Vector2 scale, string sprite)
        {
            xDimensions = width;
            yDimensions = height;
            this.scale = scale;
    ...
    public class WindowButton : WindowIcon
    {
        ...
        public WindowButton(Vector2 windowBaseBegin, Vector2 IconArea, int height, int width, Vector2 scale, string sprite, bool hoverSprite)
            : base(windowBaseBegin, IconArea, height, width, scale, sprite)
        {
    ...
    {
        public WindowTextButton(Vector2 windowBaseBegin, Vector2 IconArea, int height, int width, Vector2 scale, string sprite, bool hoverSprite)
            : base(windowBaseBegin, IconArea, height, width, scale, sprite, hoverSprite)
        {
        }
    }
    ...
    public class WindowCheckbox : WindowButton
    {
        ...
        public WindowCheckbox(Vector2 windowBaseBegin, Vector2 IconArea, int height, int width, Vector2 scale, string sprite, bool hoverSprite, bool defaultChecked)
            : base(windowBaseBegin, IconArea, height, width, scale, sprite, hoverSprite)
        {
