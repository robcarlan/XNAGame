...
namespace WindowsGame1.UI_Components.Windows
{
    public class WindowRegion
    {
        ...
        public WindowRegion( int _x, int _y, int _width, int _height, string _namePrefix, int spriteX, int spriteY, float _scale )
        {
            totalRegion.X = _x;
            totalRegion.Y = _y;
    ...
    public class WindowItemRegion : WindowRegion 
    {
        ...
        public WindowItemRegion(int _x, int _y, int _width, int _height, string _namePrefix, int spriteX, int spriteY, float _scale,
