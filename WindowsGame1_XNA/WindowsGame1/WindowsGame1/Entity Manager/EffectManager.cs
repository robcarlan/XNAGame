    ...
    public class EffectManager
    {
        ...
        public EffectManager(ContentManager content)
        {
			...
			DataLoader.EffectLoader[] _effects =
				Game1.LoadContent<DataLoader.EffectLoader[]>(Declaration.effectLoaderPath + ".xml");
            DataLoader.ExtendedEffectLoader[] _extendedEffects = null;
			Abilities.AbilityBase[] _abilities = null;
