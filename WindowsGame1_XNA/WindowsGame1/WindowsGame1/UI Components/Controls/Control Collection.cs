...
namespace WindowsGame1.UI_Components.Controls
{
    ...
    public class ControlCollection
    {
        ...
        public ControlCollection(Texture2D texture, SpriteFont font, SpriteListSimple sprites)
        {
        ...
        public void drawControls(SpriteBatch Spritebatch)
        {
            ...
            {
                Spritebatch.Draw(texture, ctrl.absolutePosition, sprites.list[ctrl.spriteID][ctrl.getCurrentState()],
